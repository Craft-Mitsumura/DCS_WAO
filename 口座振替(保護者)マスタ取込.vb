...
#End If
    ...
    Private mPathSaveFolder As String
...
#End If
    ...
    Private Sub cmdImport_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdImport.Click
        ...
        'Set PathFolder
        mPathSaveFolder = dlgFileOpen.FileName
...
ReadCSVFileToArrayError:
    ...
    Private Sub setAutoImport()
        ...
        Else
            ...
            Call MsgBox("取込エラーが発生しました", MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, mCaption)
        End If

        '// STEP5 (Export CSV Error)
        SetExportCSVError()
...
commitTransactionerr:
    ...
    Private Sub SetUpdate()
        ...
        Using connection As Npgsql.NpgsqlConnection = New Npgsql.NpgsqlConnection(gdDBS.Database.ConnectionString)
            Try
                ...
                Call MsgBox("取込が完了しました", MsgBoxStyle.OkOnly + MsgBoxStyle.Information, mCaption)
            ...
            Catch ex As Exception
                ...
                If Err.Number Then
                    ...
                    Call MsgBox("取込エラーが発生しました" & vbCrLf & errMsg, MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, mCaption)
    ...
    Private Sub SetExportCSVError()
        ...
        'dlgFileSave.FileName = reg.OutputFileNameErr(mCaption & "_エラーリスト")
