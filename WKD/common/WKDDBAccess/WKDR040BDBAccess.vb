...
Public Class WKDR040BDBAccess
    ...
    Public Function GetTbKeiyakushamaster(dtnengetu As String) As DataTable
        ...
        sql.AppendLine("group by t1.ownerno")
        sql.AppendLine("order by t1.ownerno")
    ...
    Public Function UpdateTKahenkomoku(dtnengetu As String) As Boolean
        ...
        sql.AppendLine(" 		  	coalesce(b.tesur1, 0) tesur1, ")
        ...
        sql.AppendLine(" 		  	coalesce(b.fuzken, 0) fuzken, ")
        sql.AppendLine(" 		  	coalesce(b.fuzkin, 0) fuzkin, ")
        sql.AppendLine(" 		  	coalesce(b.fufken, 0) fufken, ")
        sql.AppendLine(" 		  	coalesce(b.fufkin, 0) fufkin, ")
        sql.AppendLine(" 		  	coalesce(b.cszken, 0) cszken, ")
        sql.AppendLine(" 		  	coalesce(b.cszkin, 0) cszkin, ")
        ...
        sql.AppendLine(" 		  	((select count(*) from t_conveni_furikomi where dtnengetu = a.dtnengetu and ownerno = a.ownerno) - coalesce(b.cszken, 0)) csmken, ")
        sql.AppendLine(" 		  	((select sum(skingaku) from t_conveni_furikomi where dtnengetu = a.dtnengetu and ownerno = a.ownerno) - coalesce(b.cszkin, 0)) csmkin, ")
