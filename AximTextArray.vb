...
<ProvideProperty("Index", GetType(GrapeCity.Win.Editors.GcTextBox))> Public Class AximTextArray
    ...
    <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)> Public Function CanExtend(ByVal target As Object) As Boolean Implements IExtenderProvider.CanExtend
        If TypeOf target Is GrapeCity.Win.Editors.GcTextBox Then
            Return BaseCanExtend(target)
        End If
    End Function

    Public Function GetIndex(ByVal o As GrapeCity.Win.Editors.GcTextBox) As Short
        Dim A As ArrayList = New ArrayList()
        Return BaseGetIndex(o)
    End Function

    <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)> Public Sub SetIndex(ByVal o As GrapeCity.Win.Editors.GcTextBox, ByVal Index As Short)
        BaseSetIndex(o, Index)
    End Sub

    <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)> Public Function ShouldSerializeIndex(ByVal o As GrapeCity.Win.Editors.GcTextBox) As Boolean
        Return BaseShouldSerializeIndex(o)
    End Function

    <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)> Public Sub ResetIndex(ByVal o As GrapeCity.Win.Editors.GcTextBox)
        BaseResetIndex(o)
    End Sub

    Default Public ReadOnly Property Item(ByVal Index As Short) As GrapeCity.Win.Editors.GcTextBox
        Get
            Item = CType(BaseGetItem(Index), GrapeCity.Win.Editors.GcTextBox)
        End Get
    End Property

    Protected Overrides Function GetControlInstanceType() As System.Type
        Return GetType(GrapeCity.Win.Editors.GcTextBox)
    End Function

	Protected Overrides Sub HookUpControlEvents(ByVal o As Object)
        Dim ctl As GrapeCity.Win.Editors.GcTextBox = CType(o, GrapeCity.Win.Editors.GcTextBox)
